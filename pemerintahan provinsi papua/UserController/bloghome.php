...
<head>
    ...
    <style>
        .card-title:hover, .carousel-item img:hover, .header-title:hover, .header-subtitle:hover {
            color: #66CCFF;
...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark" style="background-color: #000080;">
        ...
        <div class="container">
            <a class="navbar-brand" href="bloghome.php" style="color: white;">Pemerintahan Provinsi Papua ☀️ </a>
    ...
    <header class="py-1 bg-light border-bottom mb-1">
        <div class="container">
            <div class="text-center my-5">
                <h1 class="fw-bolder header-title">SELAMAT DATANG DI WEBSITE PEMERINTAHAN PROVINSI PAPUA</h1>
                <p class="lead mb-0 header-subtitle">Berita Terupdate yang ada di Pemerintahan Provinsi Papua</p>
            </div>
        </div>
    </header>
    <!-- Page content-->
                                ...
                                while ($featured_row = $featured_result->fetch_assoc()) {
                                    ...
                                    <div class="carousel-item <?= $active_class ?>">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <a class="btn btn-dark" href="blogpost.php?id=<?= $featured_row['id_artikel'] ?>">Read more →</a>
                                        </div>
                                    </div>
                                    <?php
                            ...
                            <div class="col-lg-6">
                                ...
                                <div id="carouselNonFeatured<?= $row['id_artikel'] ?>" class="carousel slide card mb-4" data-bs-ride="carousel">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <a class="btn btn-dark" href="blogpost.php?id=<?= $row['id_artikel'] ?>">Read more →</a>
                                    </div>
                                </div>
                            </div>
                            <?php
                    ...
                    <div class="card-body">
                        <form action="bloghome.php" method="get">
                            <div class="input-group">
                                ...
                                <button class="btn btn-dark" id="button-search" type="submit">Go!</button>
                            </div>
                        </form>
                    </div>
                </div>
