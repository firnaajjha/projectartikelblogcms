...
<body class="d-flex flex-column min-vh-100">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark" style="background-color:#000080;">
        <div class="container">
            <a class="navbar-brand" href="bloghome.php" style="color: white;">Pemerintah Provinsi Papua ☀️</a>
    ...
    <div class="container flex-grow-1">
        <div class="row justify-content-center align-items-center">
            ...
            <div class="col-lg-4 mb-4 mb-lg-0">
                <img src="http://vscode.test/pemerintahan%20provinsi%20papua/img/tentangkami.jpg" alt="Tentang Kami" class="img-fluid rounded hover-zoom">
            </div>
            <!-- Kolom untuk teks -->
            <div class="col-lg-8">
                <div class="card mb-4">
                    <div class="card-body text-center"> <!-- Menyelaraskan teks ke tengah -->
                        ...
                        <p class="card-text">Selamat datang di website resmi Pemerintahan Papua! Kami hadir untuk menyajikan informasi terbaru dan menarik tentang segala hal yang berkaitan dengan kota tercinta ini. Dengan komitmen yang tinggi, kami berusaha menyuguhkan konten berkualitas dan bermanfaat bagi seluruh warga dan pengunjung.</p>
                        <p class="card-text">Tim penulis kami akan selalu memastikan setiap artikel ditulis dengan cermat dan teliti. Kami membahas berbagai topik mulai dari berita terkini, destinasi wisata, budaya, politik, hingga kegiatan masyarakat di sekitar Pemerintahan Provinsi Papua.</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <!-- Footer-->
    <footer class="py-5" style="background-color: #000080;">
