...
<body class="d-flex flex-column min-vh-100">
    ...
    <div class="container flex-grow-1">
        <div class="row justify-content-center align-items-center">
            ...
            <div class="col-lg-4 py-3">
                <img src="http://vscode.test/pemerintahan%20provinsi%20papua/img/contactperson.jpg" alt="Gambar Kontak" class="img-fluid hover-zoom">
            </div>
                ...
                <div class="card mb-4">
                    <div class="card-body text-start">
                        ...
                        <ul class="list-unstyled text-center">
                            <li>Email: firnajjha@gmail.com</li>
                            <li>Telepon: 081248416943</li>
                            <li>Alamat: Perumahan Istana Gajayana, Jalan Gajayana, Dinoyo, Lowokwaru, Kota Malang, Jawa Timur</li>
                        </ul>
                        <p class="card-text text-center">
                            Atau Anda bisa langsung Klik Icon Di bawah ⬇️
                        </p>
                    </div>
                </div>
            </div>
    ...
    <footer class="py-5" style="background-color: #000080;">
        <div class="container text-center text-white">
            <p class="m-0">&copy; Pemerintah Provinsi Papua 2024 </p>
            <div class="mt-3">
